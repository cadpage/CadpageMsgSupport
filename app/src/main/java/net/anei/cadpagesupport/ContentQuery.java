...
public class ContentQuery {
  ...
  public static void dumpEverything(Context context) {
    ...
    Cursor cur = res.query(Uri.parse("content://mms"), null, null, null, null);
    dumpCursor("Full MMS", cur);
  }

  public static void dumpRecentMms(Context context) {
    ContentResolver res = context.getContentResolver();
    Cursor cur = res.query(Uri.parse("content://mms"), null, null, null, "date desc limit 5");
  ...
  private static void retrieveMsg(Context context) {
    ...
    if (id < 0) {
      Cursor cur = res.query(Uri.parse("content://mms"), MMS_COL_LIST, "ct_l=? or m_id=?", new String[]{msg_id, msg_id}, null);
      if (cur == null) return;
      try {
    ...
    Cursor cur = res.query(Uri.parse("content://mms/"+id+"/part"), PART_COL_LIST, null, null, null);
